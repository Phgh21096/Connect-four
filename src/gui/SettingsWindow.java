...
public class Gui {
	...
	static final int NUMBOFROWS = Constants.NUM_OF_ROWS;
	static final int NUMBOFCOLUMNS = Constants.NUM_OF_COLUMNS;
	...
	public Gui() {
		buttons = new JButton[NUMBOFCOLUMNS];
	...
	private static void AddMenus() {
		...
		howToPlayItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null,
						"Click on the buttons or press 1-" + NUMBOFCOLUMNS
								+ " on your keyboard to insert a new checker." + "\nTo win you must place " + INAROW
								+ " checkers in an row, horizontally, vertically or diagonally.",
		...
		aboutItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JLabel label = new JLabel("<html><center>© Created by: Christos Kormaris<br>" + "Version "
						+ Constants.VERSION + "</center></html>");
	...
	public static Component createContentComponents() {
		...
		panelBoardNumbers.setLayout(new GridLayout(1, NUMBOFCOLUMNS, NUMBOFROWS, 4));
	...
	public static void gameOver() {
		...
		if (board.getWinner() == Constants.P1) {
			if (GameParameters.gameMode == GameMode.HUMAN_VS_MINIMAX_AI)
				choice = JOptionPane.showConfirmDialog(null, "You win! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
			else if (GameParameters.gameMode == GameMode.HUMAN_VS_HUMAN)
				choice = JOptionPane.showConfirmDialog(null, "Player 1 wins! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
			else if (GameParameters.gameMode == GameMode.MINIMAX_AI_VS_MINIMAX_AI)
				choice = JOptionPane.showConfirmDialog(null, "Minimax AI 1 wins! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
		} else if (board.getWinner() == Constants.P2) {
			if (GameParameters.gameMode == GameMode.HUMAN_VS_MINIMAX_AI)
				choice = JOptionPane.showConfirmDialog(null, "Computer AI wins! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
			else if (GameParameters.gameMode == GameMode.HUMAN_VS_HUMAN)
				choice = JOptionPane.showConfirmDialog(null, "Player 2 wins! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
			else if (GameParameters.gameMode == GameMode.MINIMAX_AI_VS_MINIMAX_AI)
				choice = JOptionPane.showConfirmDialog(null, "Minimax AI 2 wins! Start a new game?", "Game Over",
						JOptionPane.YES_NO_OPTION);
		} else if (board.checkForDraw()) {
			choice = JOptionPane.showConfirmDialog(null, "It's a draw! Start a new game?", "Game Over",
					JOptionPane.YES_NO_OPTION);
		}
